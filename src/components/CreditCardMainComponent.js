...
class  CreditCardMainComponent extends Component {
                                    ...
                                    >
                                        <div className="d-flex w-100 justify-content-between" >
                                            <div className="row">
                                                ...
                                                { this.props.toggleUpdate===true && <button className=" web-dev-active-dark btn btn-block btn-outline-primary web-dev-credit-card m-2" onClick={()=>{ this.props.toggleUpdate()}}> Update Card Num </button>}
                                            </div>
                                        </div>
                                        ...
                                        { this.props.toggleUpdate===false && creditCard._id ===this.props.selectedCreditCard
    ...
    export default CreditCardMainComponent